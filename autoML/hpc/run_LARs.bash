...
EXPERIMENT_SCRIPT="run_xxc.py"
#EXPERIMENT_SCRIPT="addnoise.py"
...
HPC_ARRAY="0-1023"                   # index of taskIDs to spawn tasks (has slurm configured hard limit!)
HPC_TASK_LIMIT="84"                 # hard task limit (arc-p0: 42C/84T)
