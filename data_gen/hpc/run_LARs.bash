...
EXPERIMENT_LAB="aghm"
EXPERIMENT_USER="u230292"
EXPERIMENT_NAME="datagen"
EXPERIMENT_SCRIPT="datasets_generation_final_forHPC.py"
...
### Container
CONTAINER_EXPERIMENT_BASE_PATH="/workspaces/data_gen"
CONTAINER_EXPERIMENT_SCRIPTS_PATH="${CONTAINER_EXPERIMENT_BASE_PATH}/python"

### Volumes
VOLUME_SRC_A="/home_cu/${EXPERIMENT_USER}/Projects/data_gen"
...
HPC_PARTITION="universe"                #

### HPC resources setup

HPC_MEM_PER_TASK="8G"               # max memory usage [G,M] on a node (512TiB arc-p1, 1TiB arc-p2)
...
HPC_ARRAY="0-399"                   # index of taskIDs to spawn tasks (has slurm configured hard limit!)
HPC_TASK_LIMIT="90"                 # hard task limit (arc-p0: 42C/84T)
...
if [[ \$SLURM_ARRAY_TASK_ID -eq 0 ]]; then
    ...
    apptainer pull docker://DT-IW-20-028:5000/${DOCKER_IMAGE_NAME}:${DOCKER_IMAGE_TAG}
    touch \${FILE_PATH}
fi
...
srun -o out/\${SLURM_ARRAY_TASK_ID}.out \
 apptainer exec \
